import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, h, resolveComponent, computed, mergeProps, withCtx, unref, createVNode, useSSRContext, ref, watch, createTextVNode, toDisplayString, provide, Suspense, Fragment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks, createDebugger } from "/Users/yusuf/Systems/Work/Aortem/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/yusuf/Systems/Work/Aortem/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/yusuf/Systems/Work/Aortem/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/Users/yusuf/Systems/Work/Aortem/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/yusuf/Systems/Work/Aortem/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/Users/yusuf/Systems/Work/Aortem/node_modules/ufo/dist/index.mjs";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "docs",
    path: "/docs",
    component: () => import("./_nuxt/docs-C5y4nydv.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-DEsp2ncr.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Br1DNk-O.js")
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import("./_nuxt/pricing-DXIYosuk.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BxdlF2Dk.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CYCuKz0z.js"));
...
export {
  ...
  analyticsMetrics as b,
  analyticsDetails as c,
  docsCategories as d,
  entry_default as default,
  engineCards as e,
  communityHighlights as f,
  tryUseNuxtApp as g,
  overviewBullets as o,
  pricingPlans as p,
  quickStartSlides as q,
  technidoxLogo as t,
  useCaseCards as u,
  workflowSteps as w
};
